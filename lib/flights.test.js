...
describe("flights", function() {
  ...
  describe("getAirportByCode", function() {
    it("should return airport object that correspond to the airport code", function() {
      var testCases = [
        { code: "ADL", expected: { code: "ADL", name: "Adelaide", latitude: -34.945, longitude: 138.531006, isPopular: true } },
        { code: "MEL", expected: { code: "MEL", name: "Melbourne - Tullamarine", latitude: -37.673302, longitude: 144.843002, isPopular: true } },
