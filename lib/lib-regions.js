(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("lib-regions", [], factory);
	else if(typeof exports === 'object')
		exports["lib-regions"] = factory();
	else
		root["lib-regions"] = factory();
})(window, function() {
...
module.exports = {
  currencies: {
    ...
    dealstravel: {
      AUD: {
        payment_methods: ['stripe', 'braintree']
      }
    },
    cudotravel: {
      AUD: {
    ...
    luxuryescapes: {
      AUD: {
        payment_methods: ['le_credit', 'stripe', 'braintree', 'qantas']
      },
      CAD: {
        payment_methods: ['le_credit', 'stripe']
      },
      CNY: {
        payment_methods: ['le_credit', 'stripe']
      },
...
var currencyData = __webpack_require__(/*! ./currency-data */ "./src/currency-data.js").currencies;

var regionData = __webpack_require__(/*! ./region-data */ "./src/region-data.js");

var _require = __webpack_require__(/*! ./lib/flights */ "./src/lib/flights.js"),
    getFlightRegions = _require.getFlightRegions,
    getFlightMainPort = _require.getFlightMainPort;
...
var brandRegions = Object.keys(regionData).reduce(function (acc, k) {
  acc[k] = regionData[k].map(function (region) {
    return Object.assign({}, region, {
      payment_methods: currencyData(k)[region.currency_code].payment_methods
    });
  });
  return acc;
}, {});
...
function getRegionByCode(regionCode, brand) {
  ...
  return regions(brand).find(function (region) {
    return region.code.toLowerCase() === regionCode.toLowerCase();
  });
}
...
var getFlightRegions = function getFlightRegions() {
  return ['AU'];
};
...
function getFlightMainPort(region) {
  ...
  if (!mainPort) {
    throw new Error("".concat(region, " is not configured with a main port"));
  }
...
//# sourceMappingURL=lib-regions.js.map